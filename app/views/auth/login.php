...
<head>
    ...
    <title>Masuk - Wonderland Samarinda</title>
...
<style>
    ...
    <div class="auth-top-subtitle">Masuk Pengunjung</div>
    ...
    <div class="auth-card">
        ...
        <p class="auth-card-desc">Masuk ke akun Anda</p>
        ...
        <form action="index.php?page=login_process" method="POST">
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-input-wrap">
                    ...
                    <input type="password" name="password" id="loginPassword" placeholder="••••••••" class="has-toggle" required autocomplete="current-password">
                    <button type="button" class="auth-toggle-pw" onclick="togglePw('loginPassword', this)">
            ...
            <div class="auth-form-group">
                ...
                <div class="auth-captcha-row">
                    ...
                    <a href="index.php?page=login" class="auth-captcha-refresh" title="Buat kode baru" aria-label="Buat kode baru">
                ...
                <div class="auth-input-wrap">
                    ...
                    <input type="text" name="login_challenge" placeholder="Ketik kode di atas" maxlength="5" required autocomplete="off" style="text-transform: uppercase;">
                </div>
                <small class="auth-captcha-help">Tujuan fitur ini untuk memastikan login dilakukan oleh manusia.</small>
            </div>

            <button type="submit" class="row auth-btn-submit">Masuk</button>
        </form>
...
<script>
    ...
    const popupConfig = {
        error:   { icon:'❌', iconBg:'#FCEBEB', title:'Masuk Gagal',                  btn:'#C0392B', btnText:'Coba Lagi' },
        csrf:    { icon:'⚠️', iconBg:'#FAEEDA', title:'Permintaan Tidak Valid',        btn:'#C0392B', btnText:'Muat Ulang' },
        success: { icon:'✓',  iconBg:'#EAF3DE', title:'Masuk Berhasil!',               btn:'#27ae60', btnText:'Lanjutkan' },
    ...
    window.addEventListener('DOMContentLoaded', () => {
        showPopup(
            ...
            <?= $popup_type === 'success' ? "'index.php?page=user_dashboard'" : 'null' ?>
        );
    });
    <?php endif; ?>
</script>
